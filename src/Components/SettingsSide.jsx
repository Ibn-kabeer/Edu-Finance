...
import HelpIcon from "../assets/helpdes.png";

const SettingsSide = () => {
  return (
    <>
      <div>
        <div className="bg-white gap-[1px] border-[1px] rounded-md flex -translate-y-[2px] ml-[38px] w-[1010px] h-[712px]">

          {/* Settings Sidebar */}
          <div className="ml-[15px] p-[15px] mt-[15px] bg-white rounded-md border-[1px] w-[265px] h-[301px]">

            <div className="top-[12px] left-[2px]">
              <h1 className="font-Inter text-[20px] text-[#15191E]">
                Settings
              </h1>

              <p className="text-[14px] text-[#8896AA]">
            ...
            <div className="left-[2px] gap-[12px] grid mt-[22px]">
              ...
              <Link to="/Edit">
                <button className="flex hover:border-l-[#03C987] hover:bg-[#E6FFF6] h-[40px] gap-[12px] hover:border-l-[2px]">
                  ...
                  <p className="text-[12px] leading-[20px] text-[#2B323B] font-Inter font-semibold">
                    Edit Profile
                  </p>
                </button>
              </Link>
