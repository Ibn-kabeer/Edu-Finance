        ...
        <div className="gap-[80px] flex">
          ...
          <div className="gap-[80px] flex">
            ...
            <h1
              onClick={() => {
                setopenmodal01(true);
                setopenmodal02(false);
                setopenmodal03(false);
              }}
            ...
            <h1
              onClick={() => {
                setopenmodal02(true);
                setopenmodal01(false);
                setopenmodal03(false);
              }}
              className={`text-[#8896AA] text-[16px] font-Inter hover:text-black
                ${
                  openmodal02
                    ? "border-b-2 text-black border-green-500"
                    : ""
          ...
          <div className="flex mt-[20px]">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-[7px]">
                <h1 className="text-[#556377] text-[14px] font-Inter">
                  First Name
                </h1>
                ...
                <input
                  type="text"
                  placeholder="Linda"
                  className="w-[352px] h-[48px] border-[1px] text-[#0B0C0F] p-3 rounded-md border-[#E1E5EA]"
                />
              </div>
              ...
              <div className="flex gap-[25px]">
                ...
                <div className="grid gap-[7px]">
                  ...
                  <label className="text-[#556377] text-[14px] font-Inter">
                    Select Date
                  </label>
                  ...
                  <div className="flex">
                    ...
                    <img
                      src={Vector}
                      alt="Calendar"
                      className="-translate-x-[27px] h-[25px] mt-[13px]"
                    />
            ...
            <div className="">
              ...
              <button className="border-[#15191E] mt-[20px] text-[#15191E] font-Manrope text-[14px] border-[1px] w-[173px] h-[36px]">
                Upload new picture
              </button>
              ...
              <div className="flex gap-2">
                ...
                <div className="grid gap-[7px]">
                  ...
                  <input
                    type="text"
                    placeholder="$0.00"
                    className="w-[221px] h-[50px] border-[1px] text-[#0B0C0F] p-3 rounded-md border-[#E1E5EA]"
                  />
          ...
          <div className="flex mt-[30px]">
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-[7px]">
                ...
                <h1 className="text-[16px] font-medium text-[#404A59]">
                  Work Information
                </h1>
