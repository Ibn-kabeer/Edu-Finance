    ...
    return (
        ...
        <div className="p-[30px]">
            ...
            <div className=" gap-[80px] flex">
                <h1 onClick={() => { setopenmodal01(true), setopenmodal02(false), setopenmodal03(false) }}  className={`text-[#8896AA] text-[16px] font-Inter hover:text-black ${openmodal01 && 'border border-b border-red'}`}>Personal Information</h1>
                <h1 onClick={() => { setopenmodal02(true), setopenmodal01(false), setopenmodal03(false) }} className="text-[#8896AA] text-[16px] font-Inter hover:text-black">Educational Information</h1>
                <h1 onClick={() => { setopenmodal03(true), setopenmodal01(false), setopenmodal02(false) }} className="text-[#8896AA] text-[16px] font-Inter hover:text-black mb-[13px]">Work Information</h1>
            </div>
            <hr className=""/>
