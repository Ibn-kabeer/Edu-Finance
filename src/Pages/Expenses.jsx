...
const Expenses = () => {
    ...
    return (
        <>
           ...
           <h1 className=" text-[#2B323B] font-semibold text-sm">Expenses</h1>
           ...
           <button className="border rounded-md w-[100px] text-sm mr-[0px] h-[25px]">This week</button>
            ...
            <div className="items-center flex p-3 gap-[10px]">
                    ...
                    <div className="bg-[#FDE8E8] w-[985px] h-[137px] rounded-md">
                    <div className="flex gap-2" >
                    <img src="src/assets/_3/Icons.png" alt="" className="translate-y-[20px] ml-4"/>
                    <h1 className="text-[#556377] translate-y-[20px] font-inter text-[12px] leading-[125%]  ">TOTAL EXPENSES</h1>
                    </div>
                      <p className="text-[26px] ml-[18px] translate-y-[25px] leading-[125%] font-bold text-[#2B323B] h-[33px] w-[272px] ">€ 1,800.00</p>
                    <button className="w-[140px] h-[32px] gap-[4px] rounded-full translate-x-[830px] translate-y-[40px] bg-[#0B0C0F] text-white ">Add Expenses</button>
                    </div>
             ...
             <div className="grid ml-[15px] p-[10px] items-center">
                ...
                <div className="flex mt-[19px] mb-[5px] justify-between">
                    ...
                    <div className="grid items-center]">
                        <h1 className="text-[#333333] text-[14px]">Food</h1>
                  ...
                  <div className="flex gap-[4px] mr-[10px] mt-[5px]">
                    ...
                    <img src="src/assets/_3/Paid.png" alt="" className="h-[30px]"/>
                    <div className="grid items-center]">
                        <h1 className="text-[#333333] text-[14px]">Transport</h1>
                        <span className=" text-[#8896AA] text-[10px]">Expense• 14 Jul 2024</span>
                    </div>
                    </div>
                  <p className="font-inter text-[14px] mt-[5px] text-[#15191E]">€ 600.00</p>
                  ...
                  <div className="flex gap-[4px] mr-[10px] mt-[5px]">
                    ...
                    <img src="src/assets/_3/Paid.png" alt="" className="h-[30px]"/>
                    <div className="grid items-center]">
                        <h1 className="text-[#333333] text-[14px]">Rent</h1>
                        <span className=" text-[#8896AA] text-[10px]">Expense• 14 Jul 2024</span>
                    </div>
                    </div>
                  <p className="font-inter text-[14px] mt-[5px] text-[#15191E]">€ 600.00</p>
                  ...
                  <div className="flex mt-[10px] mb-[5px] justify-between">
                    ...
                    <img src="src/assets/_3/Paid.png" alt="" className="h-[30px]"/>
                    <div className="grid items-center]">
                        <h1 className="text-[#333333] text-[14px]">Utility Bills</h1>
                        <span className=" text-[#8896AA] text-[10px]">Expense• 14 Jul 2024</span>
                    </div>
                    </div>
                  <p className="font-inter text-[14px] mt-[5px] text-[#15191E]">€ 600.00</p>
